...
## The name of a Pygments style to use for syntax highlighting:  murphy, autumn,
#  monokai, manni, vim, lovelace, fruity, borland, vs, perldoc, algol, rrt,
#  default, bw, xcode, friendly, algol_nu, colorful, emacs, paraiso-light, igor,
#  native, trac, paraiso-dark, pastie, tango
